...
const questionGenerator = () => {
  ...
  let [num1, num2] = [randomValue(1, 25), randomValue(1, 25)];

  //for getting random operators
  ...
  //(1 for num1 , 2 for num2 , 3 for operator,
  // anything else(4) for solution)
  ...
  submitBtn.addEventListener("click", () => {
    ...
    if (userInput) {
      ...
      // if user inputs opartor other than + * -
